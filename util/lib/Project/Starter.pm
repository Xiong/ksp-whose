...
#       
# Purpose   : Implement command line interface.
# Parms     : @argv                         : normally @ARGV
# Returns   : 0 for success, 1 for error    : bash convention
# Throws    : ____
# See also  : ____
# 
# ____
...
#=========# INTERNAL ROUTINE
#
#   _get_master_config();     # get config from master config file
#       
# Purpose   : ____
# Parms     : ____
# Reads     : ____
