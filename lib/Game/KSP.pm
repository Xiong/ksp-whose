package Game::KSP;                  # Interact with Kerbal Space Program files
...
Game::KSP - Interact with Kerbal Space Program files

=head1 VERSION

This document describes Game::KSP version 0.0.0
...
I<< Mars ain't the kind of place to raise your kids. >> 
    -- Bernie Taupin
...
L<https://github.com/Xiong/ksp-whose/issues>.

=head1 DEVELOPMENT

This project is hosted on GitHub at: 
L<https://github.com/Xiong/ksp-whose>. 
